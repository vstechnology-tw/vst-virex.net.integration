...
| 資料模型 | 用途 |
| --- | --- |
| [ProductInfo](payloads/product/product-info.md) | 執行與結果關聯使用的產品資訊。 |
| [SystemStatus](payloads/system/system-status.md) | 目前生命週期狀態。 |
| [CommandResponse](payloads/commands/command-response.md) | 命令接受或拒絕的結果。 |
| [ResultSummary](payloads/results/result-summary.md) | 已完成執行的公開摘要資料。 |
| [ErrorInfo](payloads/system/error-info.md) | 目前作用中的錯誤資訊。 |
