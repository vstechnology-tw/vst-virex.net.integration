...
| --- | --- | --- | --- | --- | --- |
| Status | GET | `/api/status` | 讀取目前系統狀態。 | Any | [SystemStatus](payloads/system/system-status.zh.md) |
| ProductInfo | GET | `/api/product-info` | 讀取目前 ProductInfo。 | Any | [ProductInfo](payloads/product/product-info.zh.md) |
| ProductInfo | POST | `/api/product-info` | 更新目前 ProductInfo。 | `Ready` | [CommandResponse](payloads/commands/command-response.zh.md) |
| System | POST | `/api/system/initialize` | 初始化系統。 | `Uninitialized` | [CommandResponse](payloads/commands/command-response.zh.md) |
| System | POST | `/api/system/deinitialize` | 反初始化系統。 | `Ready` | [CommandResponse](payloads/commands/command-response.zh.md) |
| System | POST | `/api/system/start` | 啟動一次執行。 | `Ready` | [CommandResponse](payloads/commands/command-response.zh.md) |
| System | POST | `/api/system/stop` | 停止目前執行。 | `Running` | [CommandResponse](payloads/commands/command-response.zh.md) |
| Results | GET | `/api/results` | 查詢結果摘要。 | Any | [ResultList](payloads/results/result-list.zh.md) |
...
| HTTP status | Body | 說明 |
| --- | --- | --- |
| `200 OK` | [SystemStatus](payloads/system/system-status.zh.md) | 回傳目前狀態。 |
...
一般情況不會回傳 [CommandResponse](payloads/commands/command-response.zh.md)。連線失敗、服務未啟動或非 JSON 回應應視為傳輸或 HTTP 錯誤。
...
| HTTP status | Body | 說明 |
| --- | --- | --- |
| `200 OK` | [ProductInfo](payloads/product/product-info.zh.md) | 回傳目前 ProductInfo。 |
...
| Route | `/api/product-info` |
| Query | none |
| Body | [ProductInfo](payloads/product/product-info.zh.md) |
...
| HTTP status | Body | 說明 |
| --- | --- | --- |
| `200 OK` | [CommandResponse](payloads/commands/command-response.zh.md) | ProductInfo 更新完成。 |
| `409 Conflict` | [CommandResponse](payloads/commands/command-response.zh.md) | 目前狀態不允許更新 ProductInfo。 |
...
| HTTP status | Body | 說明 |
| --- | --- | --- |
| `200 OK` | [CommandResponse](payloads/commands/command-response.zh.md) | 初始化完成。 |
| `409 Conflict` | [CommandResponse](payloads/commands/command-response.zh.md) | 目前狀態不允許初始化。 |
...
| HTTP status | Body | 說明 |
| --- | --- | --- |
| `200 OK` | [CommandResponse](payloads/commands/command-response.zh.md) | 反初始化完成。 |
| `409 Conflict` | [CommandResponse](payloads/commands/command-response.zh.md) | 目前狀態不允許反初始化。 |
...
| Query | none |
| Body | [SystemStartRequest](payloads/commands/system-start-request.zh.md) 或無 |
...
| HTTP status | Body | 說明 |
| --- | --- | --- |
| `200 OK` | [CommandResponse](payloads/commands/command-response.zh.md) | 已進入 `Running`。 |
| `409 Conflict` | [CommandResponse](payloads/commands/command-response.zh.md) | 目前狀態不允許啟動。 |
...
| Query | none |
| Body | [SystemStopRequest](payloads/commands/system-stop-request.zh.md) 或無 |
...
| HTTP status | Body | 說明 |
| --- | --- | --- |
| `200 OK` | [CommandResponse](payloads/commands/command-response.zh.md) | 已停止並回到 `Ready`。 |
| `409 Conflict` | [CommandResponse](payloads/commands/command-response.zh.md) | 目前狀態不允許停止。 |
...
| HTTP status | Body | 說明 |
| --- | --- | --- |
| `200 OK` | [ResultList](payloads/results/result-list.zh.md) | 回傳符合條件的結果摘要。 |
...
系統命令或 ProductInfo 更新在不合法狀態下呼叫時，會回傳 `409 Conflict` 與 [CommandResponse](payloads/commands/command-response.zh.md)：
