...
| topic | 資料內容 | 發布時機 |
| --- | --- | --- |
| `virex/statusChanged` | [SystemStatus](payloads/system/system-status.zh.md) | 公開狀態改變。 |
| `virex/productInfoChanged` | [ProductInfo](payloads/product/product-info.zh.md) | ProductInfo 更新完成。 |
| `virex/runStarted` | [SystemStatus](payloads/system/system-status.zh.md) | 狀態進入 `Running`。 |
| `virex/runCompleted` | [SystemStatus](payloads/system/system-status.zh.md) | 一次執行離開 `Running` 並回到 `Ready`。 |
| `virex/resultCreated` | [ResultSummary](payloads/results/result-summary.zh.md) | 建立結果摘要。 |
| `virex/errorChanged` | [ErrorInfo](payloads/system/error-info.zh.md) | 公開錯誤狀態改變。 |
| `virex/commandRejected` | [CommandResponse](payloads/commands/command-response.zh.md) | 命令因狀態規則或驗證失敗被拒絕。 |
...
[SystemStatus](payloads/system/system-status.zh.md)
...
[ProductInfo](payloads/product/product-info.zh.md)
...
`Start` 會在執行完成前先回應。用戶端應等待 `resultCreated`、`runCompleted`，或查詢 [GET /api/results](rest-api.zh.md#get-apiresults)。
...
[ResultSummary](payloads/results/result-summary.zh.md)
...
[ErrorInfo](payloads/system/error-info.zh.md)
...
[CommandResponse](payloads/commands/command-response.zh.md)
